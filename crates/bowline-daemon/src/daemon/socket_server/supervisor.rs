...
use crate::daemon::socket_server::{
    BlockingAcceptor, ConnectionExecutor, MAX_CONCURRENT_CONNECTIONS, ThreadJoinReport,
    run_scheduler,
};
...
pub(super) struct ShutdownReport {
    ...
    pub(super) rpc_metrics: super::super::rpc_service::RpcExecutorMetricsSnapshot,
}
...
pub(super) struct DaemonThreads {
    ...
    rpc_executor: Arc<super::super::rpc_service::RpcExecutor>,
...
impl DaemonThreads {
    pub(super) fn start(
        ...
        let rpc_executor = Arc::new(super::super::rpc_service::RpcExecutor::new(
            super::super::rpc_service::RpcExecutorConfig::default(),
        )?);
    ...
    pub(super) fn rpc_executor(&self) -> &Arc<super::super::rpc_service::RpcExecutor> {
        &self.rpc_executor
    }
...
fn rollback_startup(
    ...
    rpc_executor: &super::super::rpc_service::RpcExecutor,
